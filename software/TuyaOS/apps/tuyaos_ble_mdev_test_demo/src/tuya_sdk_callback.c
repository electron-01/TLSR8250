 ...
 * @brief This is tuya sdk_callback file
 * @version 1.0
 * @date 2021-09-10
 *
...
#if defined(ENABLE_SCAN) && (ENABLE_SCAN == 1)
...
#if defined(ENABLE_SCAN) && (ENABLE_SCAN == 1)
            app_mdev_rssi_recv(p_event->ble_event.adv_report.p_data,\
                                        p_event->ble_event.adv_report.data_len,\
                                        p_event->ble_event.adv_report.peer_addr.addr,\
                                        p_event->ble_event.adv_report.rssi);
#endif
