 ...
 * @brief This is tuya ble_protocol_callback file
 * @version 1.0
 * @date 2021-09-10
 *
...
STATIC TIMER_ID update_conn_param_timer;
...
STATIC VOID_T tuya_ble_disconnect_and_reset_timer_cb(TIMER_ID timer_id, VOID_T *arg)
{
...
STATIC VOID_T tuya_ble_update_conn_param_timer_cb(TIMER_ID timer_id, VOID_T *arg)
{
...
{
    tal_sw_timer_create(tuya_ble_disconnect_and_reset_timer_cb, NULL, &disconnect_timer);
}

VOID_T tuya_ble_update_conn_param_timer_init(VOID_T)
{
    tal_sw_timer_create(tuya_ble_update_conn_param_timer_cb, NULL, &update_conn_param_timer);
}

VOID_T tuya_ble_disconnect_and_reset_timer_start(VOID_T)
{
    tal_sw_timer_start(disconnect_timer, 1000, TAL_TIMER_ONCE);
}

VOID_T tuya_ble_update_conn_param_timer_start(VOID_T)
{
    tal_sw_timer_start(update_conn_param_timer, 1000, TAL_TIMER_ONCE);
}
