...
#define TY_DEVICE_PID         "lnn11hve" //oem no use
#define TY_DEVICE_MAC         "DC234FC6F6C3"
#define TY_DEVICE_DID         "uuid8c09facae1fa" //16Bytes
#define TY_DEVICE_AUTH_KEY    "ArB5zmEET40kxtBTjtmCefzToftzzHh6" //32Bytes

#define TY_ADV_INTERVAL       1000   //range: 20~10240ms
