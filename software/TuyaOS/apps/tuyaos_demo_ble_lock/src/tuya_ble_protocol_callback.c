...
STATIC VOID_T tuya_ble_protocol_callback(tuya_ble_cb_evt_param_t* event)
{
    switch (event->evt) {
        ...
        case TUYA_BLE_CB_EVT_DP_DATA_SEND_RESPONSE: {
            TAL_PR_INFO("TUYA_BLE_CB_EVT_DP_DATA_SEND_RESPONSE");
        } break;

        case TUYA_BLE_CB_EVT_DP_DATA_WITH_TIME_SEND_RESPONSE: {
            TAL_PR_INFO("TUYA_BLE_CB_EVT_DP_DATA_WITH_TIME_SEND_RESPONSE");
        } break;
        ...
        case TUYA_BLE_CB_EVT_DP_QUERY: {
            ...
            // YOUR JOBS: here just a demo sync the dev vbat percent.
            UINT8_T vbat_value[4] = {0, 0, 0, 100};
        ...
        case TUYA_BLE_CB_EVT_DATA_PASSTHROUGH: {
            TAL_PR_INFO("TUYA_BLE_CB_EVT_DATA_PASSTHROUGH");
        } break;
