...
#define TY_DEVICE_PID         "3yglvz27" //oem no use
#define TY_DEVICE_MAC         "DC234FC9FD4A"
#define TY_DEVICE_DID         "uuid983c00f032ba" //16Bytes
#define TY_DEVICE_AUTH_KEY    "ZdjYARud9kWlA3EYuBPkRWIOo9deUYDq" //32Bytes
